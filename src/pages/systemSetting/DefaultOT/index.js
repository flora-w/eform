...
import { Card, Table, Button, Col, Form, Input, Row ,Tag,DatePicker} from 'antd';
...
const AgentQuery = props => {
  ...
  useEffect(() => {
    const temp = [
      [
        {id: 'empno', label: '工號:', col: 3, inputCol: 4},
        {id: 'chname', label: '加班日期:', col: 3, inputCol: 4,render:(text,record)=><DatePicker />},
